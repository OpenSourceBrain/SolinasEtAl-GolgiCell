...
CHANNELS="NaP_CML.channel.nml KV_CML.channel.nml KA_CML.channel.nml  Kslow_CML.channel.nml NaT_CML.channel.nml NaR_CML.channel.nml CaHVA_CML.channel.nml CaLVA_CML.channel.nml hcn1f_CML.channel.nml  hcn1s_CML.channel.nml  hcn2f_CML.channel.nml  hcn2s_CML.channel.nml"
